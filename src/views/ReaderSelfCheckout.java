...
class ReaderSelfCheckout extends ViewTemplate
{
    ...
    public ReaderSelfCheckout(final TApplication application)
    {
        super(application, "Self Checkout Media");
        ...
        addButton("&Return", getWidth()-14, getHeight() - 4, 
            new TAction() 
            {
                public void DO() 
                {
                    getApplication().closeWindow(ReaderSelfCheckout.this);
